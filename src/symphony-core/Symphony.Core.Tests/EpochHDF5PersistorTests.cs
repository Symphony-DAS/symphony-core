...
namespace Symphony.Core
{
    ...
    internal class EpochHDF5PersistorTests
    {
        ...
        public void Setup()
        {
            ...
            var e = new TestEpoch(protocolID, parameters);
            ...
            e.SetStartTime(Maybe<DateTimeOffset>.Yes(start));
        ...
        private ExternalDeviceBase dev1;
        private ExternalDeviceBase dev2;
        private const string dev1Name = "Device1";
        private const string dev2Name = "Device2";
        private const string param1 = "key1";
        private const int value1 = 1;
        private const string param2 = "key2";
        ...
        public void ShouldAllowNestedEpochGroupsInHDF5()
        {
            ...
            var gID = new Guid("{FE5B733F-B3FB-4523-BDCC-CECB97D1CB0B}");
            using (
                var exp = new EpochHDF5Persistor("..\\..\\..\\ShouldAllowNestedEpochGroupsInHDF5.h5", null, () => gID))
            {
                var time = new DateTimeOffset(1000, TimeSpan.Zero);
                var guid = new Guid("053C64D4-ED7A-4128-AA43-ED115716A97D");
                var guid2 = new Guid("053C64D4-ED7A-4128-AA43-ED115716A97E");
        ...
        public void ShouldAppendToExistingFile()
        {
            ...
            using (var exp = new EpochHDF5Persistor("..\\..\\..\\ShouldAppendToExistingFile.h5", null, () => gID))
            {
                ...
                var guid2 = new Guid("053C64D4-ED7A-4128-AA43-ED115716A97F");

...
namespace Heka.NativeInterop
{
    ...
    public partial class ITCMM
    {
        ...
        [DllImport("ITCMM.dll", EntryPoint = "ITC_Devices", CallingConvention=CallingConvention.Cdecl)]
        ...
        ///DeviceNumber: unsigned int
        ///DeviceHandle: HANDLE*
        [DllImport("ITCMM.dll", EntryPoint = "ITC_GetDeviceHandle", CallingConvention=CallingConvention.Cdecl)]
        ...
        ///DeviceType: unsigned int*
        ///DeviceNumber: unsigned int*
        [DllImport("ITCMM.dll", EntryPoint = "ITC_GetDeviceType", CallingConvention=CallingConvention.Cdecl)]
        ...
        ///Mode: unsigned int
        ///DeviceHandle: HANDLE*
        [DllImport("ITCMM.dll", EntryPoint = "ITC_OpenDevice", CallingConvention=CallingConvention.Cdecl)]
        public static extern uint ITC_OpenDevice(uint DeviceType, uint DeviceNumber, uint Mode, out System.IntPtr DeviceHandle);


        /// Return Type: unsigned int
        ///DeviceHandle: HANDLE->void*
        [DllImport("ITCMM.dll", EntryPoint = "ITC_CloseDevice", CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport("ITCMM.dll", EntryPoint = "ITC_InitDevice", CallingConvention = CallingConvention.Cdecl)]
        ...
        ///DeviceHandle: HANDLE->void*
        ///file_path: char*
        [DllImport("ITCMM.dll", EntryPoint = "ITC_LogOpen", CallingConvention=CallingConvention.Cdecl)]
        public static extern uint ITC_LogOpen(System.IntPtr DeviceHandle, [In()] [MarshalAs(System.Runtime.InteropServices.UnmanagedType.LPStr)] string file_path);


        /// Return Type: unsigned int
        ///DeviceHandle: HANDLE->void*
        ///mask: int
        [DllImport("ITCMM.dll", EntryPoint = "ITC_LogEnable", CallingConvention=CallingConvention.Cdecl)]
        public static extern uint ITC_LogEnable(System.IntPtr DeviceHandle, int mask);


        /// Return Type: unsigned int
        ///DeviceHandle: HANDLE->void*
        [DllImport("ITCMM.dll", EntryPoint = "ITC_LogDisable", CallingConvention=CallingConvention.Cdecl)]
        public static extern uint ITC_LogDisable(System.IntPtr DeviceHandle);


        /// Return Type: unsigned int
        ///DeviceHandle: HANDLE->void*
        [DllImport("ITCMM.dll", EntryPoint = "ITC_LogClose", CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport("ITCMM.dll", EntryPoint = "ITC_GetDeviceInfo", CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport("ITCMM.dll", EntryPoint = "ITC_GetDeviceInfoEx", CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport("ITCMM.dll", EntryPoint = "ITC_GetVersions", CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport("ITCMM.dll", EntryPoint = "ITC_GetSerialNumbers", CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport("ITCMM.dll", EntryPoint = "ITC_GetStatusText", CallingConvention=CallingConvention.Cdecl)]
        ...
        ///Text: char*
        ///MaxCharacters: unsigned int
        [DllImport("ITCMM.dll", EntryPoint = "ITC_AnalyzeError", CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport("ITCMM.dll", EntryPoint = "ITC_SetSoftKey", CallingConvention=CallingConvention.Cdecl)]
        ...
        ///DeviceHandle: HANDLE->void*
        ///sParam: ITCStatus*
        [DllImport("ITCMM.dll", EntryPoint = "ITC_GetState", CallingConvention=CallingConvention.Cdecl)]
        ...
        ///DeviceHandle: HANDLE->void*
        ///sParam: ITCStatus*
        [DllImport("ITCMM.dll", EntryPoint = "ITC_SetState", CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport("ITCMM.dll", EntryPoint = "ITC_GetFIFOInformation", CallingConvention=CallingConvention.Cdecl)]
        ...
        ///DeviceHandle: HANDLE->void*
        ///Seconds: double*
        [DllImport("ITCMM.dll", EntryPoint = "ITC_GetTime", CallingConvention=CallingConvention.Cdecl)]
        public static extern uint ITC_GetTime(System.IntPtr DeviceHandle, out double Seconds);


        /// Return Type: unsigned int
        ///DeviceHandle: HANDLE->void*
        [DllImport("ITCMM.dll", EntryPoint = "ITC_ResetChannels", CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport("ITCMM.dll", EntryPoint = "ITC_SetChannels", CallingConvention=CallingConvention.Cdecl)]
        ...
        /// Return Type: unsigned int
        ///DeviceHandle: HANDLE->void*
        [DllImport("ITCMM.dll", EntryPoint = "ITC_UpdateChannels", CallingConvention=CallingConvention.Cdecl)]
        ...
        ///NumberOfChannels: unsigned int
        ///Channels: ITCChannelInfo*
        [DllImport("ITCMM.dll", EntryPoint = "ITC_GetChannels", CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport("ITCMM.dll", EntryPoint = "ITC_ConfigDevice", CallingConvention=CallingConvention.Cdecl)]
        ...
        ///DeviceHandle: HANDLE->void*
        ///sParam: ITCStartInfo*
        [DllImport("ITCMM.dll", EntryPoint = "ITC_Start", CallingConvention=CallingConvention.Cdecl)]
        ...
        ///DeviceHandle: HANDLE->void*
        ///sParam: void*
        [DllImport("ITCMM.dll", EntryPoint = "ITC_Stop", CallingConvention=CallingConvention.Cdecl)]
        ...
        ///DeviceHandle: HANDLE->void*
        ///sParam: void*
        [DllImport("ITCMM.dll", EntryPoint = "ITC_UpdateNow", CallingConvention=CallingConvention.Cdecl)]
        ...
        ///NumberOfChannels: unsigned int
        ///sParam: ITCLimited*
        [DllImport("ITCMM.dll", EntryPoint = "ITC_SingleScan", CallingConvention=CallingConvention.Cdecl)]
        ...
        ///NumberOfChannels: unsigned int
        ///sParam: ITCChannelDataEx*
        [DllImport("ITCMM.dll", EntryPoint = "ITC_AsyncIO", CallingConvention=CallingConvention.Cdecl)]
        ...
        ///NumberOfChannels: unsigned int
        ///sParam: ITCChannelDataEx*
        [DllImport("ITCMM.dll", EntryPoint = "ITC_GetDataAvailable", CallingConvention=CallingConvention.Cdecl)]
        ...
        ///NumberOfChannels: unsigned int
        ///sParam: ITCChannelDataEx*
        [DllImport("ITCMM.dll", EntryPoint = "ITC_UpdateFIFOPosition", CallingConvention=CallingConvention.Cdecl)]
        ...
        ///NumberOfChannels: unsigned int
        ///sParam: ITCChannelDataEx*
        [DllImport("ITCMM.dll", EntryPoint = "ITC_ReadWriteFIFO", CallingConvention=CallingConvention.Cdecl)]
        ...
        ///NumberOfChannels: unsigned int
        ///sParam: ITCChannelDataEx*
        [DllImport("ITCMM.dll", EntryPoint = "ITC_GetFIFOPointers", CallingConvention=CallingConvention.Cdecl)]
